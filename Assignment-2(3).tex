...
Solution:\\
Let $X_n$ define a markov chain where n$\in$\brak{0,1,2,...}. $S_1,S_2,S_3,S_4$ be four respective states denoting 
\begin{center}
...
\begin{tikzpicture}[font=\sffamily]
        ...
        % Draw the states
        \node[node style] at (0, 0)     (1)     {S1};
        \node[node style] at (6, 0)     (2)     {S2};
        \node[node style] at (0, 6)     (3)     {S4};
        \node[node style] at (6, 6)     (4)     {S3};
        ...
        \draw[every loop,
              ...
              draw=orange,
              fill=orange]
            (1)     edge[bend left=20]            node {0.5} (3)
            (1)     edge[bend right=20, auto=left] node {0.5} (2)
            (2)     edge[bend right=20]            node {0.5} (1)
            (2)     edge[bend right=20, auto=left] node {0.5} (4)
